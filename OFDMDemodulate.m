function reGrid = OFDMDemodulate(gnb,waveform,varargin)
    ...
    nFFT = info.Nfft;
    cpLengths = info.CyclicPrefixLengths*4;
    symbolsPerSubframe = info.SymbolsPerSubframe;
    samplesPerSubframe =122.88e6*1e-3; %info.SamplesPerSubframe;       
    ...
    for symbol = initialsymbol+(0:nSymbols-1) 
        ...
        fftOutput = fftshift(fft(symwaveform).*phaseCorrection,1)./(8192/sqrt(6600));
        ...
        ind = OFDMSymbolIndices(reGrid,symbol-initialsymbol+1);
