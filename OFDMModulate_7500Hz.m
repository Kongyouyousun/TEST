function [waveform,info] = OFDMModulate_7500Hz(gnb,grid,varargin)
    ...
    info.NSubcarriers = info.NSubcarriers*10;
    info.Nfft = 2048*8;
    % Cache the main dims
    nSC = info.NSubcarriers;
%     info.SubcarrierSpacing=7.5;
    nFFT = info.Nfft;
    cpLengths = info.CyclicPrefixLengths*8;
    symbolsPerSubframe = length(cpLengths);
