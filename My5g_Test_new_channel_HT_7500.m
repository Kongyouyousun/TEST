...
%         end
    ...
    for antNo = 1:32
        ...
        rxWaveform_7500(:,antNo)=tmp(1:end-2119);  %39,209,539      114816x32
    end
...
%     for port=1:32
        ...
        for i=1:size(rxGrid_7500,2)  % normalCP
            noise_dmrs=sqrt(sigma2/2)* (randn(size(rxGrid_7500(:,i,:)))+1i*randn(size(rxGrid_7500(:,i,:)))); %1320x14
            rxGrid_7500(:,i,:)=rxGrid_7500(:,i,:)+noise_dmrs;
        end
