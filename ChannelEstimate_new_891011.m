function chEst = ChannelEstimate_new_891011(grid,txgrid,csiind)
...
for numRx = 1:32
    ...
    for numTx =1:32
        ...
        indices = csiind(1:length(csiind)/4,numTx)-size(grid,1)*7;
...
%         y=[y1 y2 y3 y4 y5 y6 y7 y8 y9 y10 y11 y12];
          y=mean([y8 y9 y10 y11],2);%改 0301 22：24 
%           y=y(:,ones(size(grid,2)));
%         y=y1;
